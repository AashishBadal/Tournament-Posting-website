...
const CTA = () => {
  ...
  return (
    <div className="relative py-20 overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
          Join thousands of players and athletes in the ultimate competitive experience!
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
          ...
          >
            ...
            <span  className="relative text-white font-bold text-lg">Sign Up Now</span>
          ...
          >
            ...
            <span className="relative font-bold text-lg">Browse Tournaments</span>
            <span className="absolute right-0 pr-2 duration-300 ease-out group-hover:translate-x-1">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
