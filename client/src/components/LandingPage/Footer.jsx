        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-2xl font-bold bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">TourneyHub</h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your ultimate platform for esports and outdoor tournaments. Join thousands of competitors in thrilling events.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-300">Quick Links</h4>
            <ul className="space-y-3">
              {['Home', 'Esports', 'Outdoor', 'How It Works', 'Pricing'].map((item) => (
                <li key={item}>
                  <a 
                    href="#" 
                  ...
                  >
                    ...
                    <svg className="w-4 h-4 ml-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-300">Contact</h4>
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:support@tourneyhub.com" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">support@tourneyhub.com</a>
                </div>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-indigo-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <a href="tel:+9779800000000" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">+977 98XXXXXXX</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          {/* Social Media */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-300">Follow Us</h4>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="flex items-center space-x-2 text-gray-400 hover:text-indigo-400 transition-colors duration-200 p-2 rounded-lg hover:bg-gray-800"
                >
