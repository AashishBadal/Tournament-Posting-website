        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-indigo-400 transition duration-300 flex items-start">
                  <svg className="w-4 h-4 mt-1 mr-2 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400 hover:text-indigo-400 transition duration-300">+1 (555) 123-4567</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400 hover:text-indigo-400 transition duration-300">123 Tournament St, Sports City</span>
              </li>
            </ul>
          </div>
        </div>
